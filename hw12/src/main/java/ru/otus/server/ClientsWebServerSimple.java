...
public class ClientsWebServerSimple implements ClientsWebServer {
    ...
    public ClientsWebServerSimple(int port, TemplateProcessor templateProcessor) {
    ...
    private ServletContextHandler createServletContextHandler() {
        ...
        var clientSecond = dbServiceClient.saveClient(new Client(null, "Client2", new Address(null, "Lenina"), List.of(new Phone(null, "232425"), new Phone(null, "123123"))));
